...
namespace PetGuardianAPI.Migrations
{
    ...
    [Migration("20240505182214_AnimalesActualizacion")]
    partial class AnimalesActualizacion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetGuardianAPI.Entidades.animales", b =>
                {
                    b.HasOne("PetGuardianAPI.Entidades.tipoAnimal", "tipoAnimal")
                        .WithMany()
                        .HasForeignKey("tipoAnimalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PetGuardianAPI.Entidades.vacunas", "vacunas")
                        .WithMany()
